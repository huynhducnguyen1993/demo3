...
from .models import (User,Quatrinhdongbhxh,Phieuluong_upload,
                     Nhanvien,Phongban,Chucvu_Congviec,Loaihopdong,
                     Phieuluong_upload,Quanlyhopdongkinhdoanh,Baohiemyte,Baohiemxahoi,Hosonhanvien)
